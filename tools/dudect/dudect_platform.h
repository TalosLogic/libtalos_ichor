 ...
 */
int ichor_dudect_pin_cpu(int cpu);
 ...
 */
void ichor_dudect_check_governor(FILE *out);
 ...
 * for the 10 us per-trial target on both x86_64 and Apple Silicon).
 */
int ichor_dudect_default_reps_scale(void);
