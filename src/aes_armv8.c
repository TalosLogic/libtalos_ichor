 ...
 *
 * Compiled only when ICHOR_HAVE_ARMV8_AES is defined.  This TU is
...
static void key_expand_128_armv8(ichor_aes_ctx_t *, const uint8_t *);
static void key_expand_192_armv8(ichor_aes_ctx_t *, const uint8_t *);
static void key_expand_256_armv8(ichor_aes_ctx_t *, const uint8_t *);
...
static void
key_expand_128_armv8(ichor_aes_ctx_t *ctx, const uint8_t *key)
{
...
static void
key_expand_192_armv8(ichor_aes_ctx_t *ctx, const uint8_t *key)
{
...
static void
key_expand_256_armv8(ichor_aes_ctx_t *ctx, const uint8_t *key)
{
...
int
aes_armv8_key_expand(ichor_aes_ctx_t *ctx, const uint8_t *key, int key_bits)
{
    switch (key_bits) {
    case 128:
    ...
    ctx->backend_tag = ICHOR_AES_BACKEND_ARMV8;
    return 0;
}
 ...
 */
void
aes_armv8_encrypt(const ichor_aes_ctx_t *ctx, uint8_t out[16],
                  const uint8_t in[16])
{
 ...
 */
void
aes_armv8_encrypt_x4(const ichor_aes_ctx_t *ctx, uint8_t out[64],
                     const uint8_t in[64])
{
    const uint8_t *rk = ctx->storage;
...
const ichor_aes_ops_t ichor_aes_ops_armv8 = {
    .key_expand = aes_armv8_key_expand,
    .encrypt = aes_armv8_encrypt,
    .encrypt_x4 = aes_armv8_encrypt_x4,
    .backend_tag = ICHOR_AES_BACKEND_ARMV8,
    .name = "armv8",
};

#else /* !ICHOR_HAVE_ARMV8_AES */
...
typedef int ichor_aes_armv8_translation_unit_not_empty;
