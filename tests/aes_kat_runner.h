...
#ifndef ICHOR_TEST_AES_KAT_RUNNER_H
#define ICHOR_TEST_AES_KAT_RUNNER_H
 ...
 *
 * backend_name:  short label printed in test output ("ichor_aes",
 *                "aes_ct64", etc.).
...
#endif /* ICHOR_TEST_AES_KAT_RUNNER_H */
